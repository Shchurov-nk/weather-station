// Let's Encrypt / ISRG root CAs (self-signed). Leaf certs rotate every ~90 days,
// roots do not — no re-flash needed on renewal.
// X1 (to 2035) + X2 (to 2040) are the current trust anchors; Root YE + YR (to 2045)
// are the next generation already used in served chains via cross-signs.
